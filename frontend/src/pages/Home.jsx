...
const IconMapSearch = () => (
  ...
  >
    ...
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M9 2C5.134 2 2 5.134 2 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.866-3.134-7-7-7z"
    />
    <circle cx="18.5" cy="18.5" r="2.5" />
    <path strokeLinecap="round" d="M21 21l-1.2-1.2" />
  </svg>
...
function BigPropertyCard({ property }) {
	...
	if (!property) return <div style={{ borderRadius: 16, background: "#f1f5f9", minHeight: 360, display: "flex", alignItems: "center", justifyContent: "center" }}><span style={{ color: "#94a3b8" }}>No properties found</span></div>;
	return (
		<div
...
function SmallPropertyCard({ property }) {
	const [hovered, setHovered] = useState(false);
	if (!property) return <div style={{ borderRadius: 16, background: "#f1f5f9", minHeight: 220 }} />;
	return (
		<div
			onMouseEnter={() => setHovered(true)}
			onMouseLeave={() => setHovered(false)}
		...
		>
			...
			<div style={{ padding: "14px 16px", display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 8 }}>
				...
				{property.status && property.status !== 'available' ? (
					<span style={{ height: 32, padding: "0 12px", borderRadius: "16px", background: property.status === 'rented' ? "#f59e0b" : "#ef4444", color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'DM Sans', sans-serif", fontSize: 12, fontWeight: 700 }}>
						{property.status.toUpperCase()}
					</span>
				) : (
					<button
						...
						style={{ height: 32, padding: "0 12px", borderRadius: "16px", border: "none", background: "#3b82f6", color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", flexShrink: 0, fontFamily: "'DM Sans', sans-serif", fontSize: 12, fontWeight: 700 }}
					>
						Request
					</button>
				)}
    ...
    >
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            "linear-gradient(to top, rgba(6,10,24,0.9) 0%, rgba(6,10,24,0.35) 50%, transparent 100%)",
        }}
      />
      <div
        style={{
...
=======
  ...
  return (
    ...
    >
      ...
      <div style={{ color: "#1e293b", marginBottom: 40, marginTop: 8 }}>
        {icon}
      </div>
      <p
        style={{
  ...
  return (
    <>
      ...
      >
        ...
        >
          ...
          <div
            style={{
              ...
              inset: 0,
              background:
                "linear-gradient(100deg, rgba(2,6,23,0.8) 24%, rgba(2,6,23,0.2) 72%)",
            }}
          />
          <div
            style={{
              ...
              inset: 0,
              background:
                "radial-gradient(circle at 18% 38%, rgba(148,163,184,0.22), transparent 42%)",
            }}
          />
          {/* Hero content wrapper: headline on left, search card on right */}
          <div
          ...
          >
            <div style={{ maxWidth: 600 }}>
              ...
              >
                Discover homes for sale or rent, explore locations on the map,
                and manage your property journey with ease.
              </p>
            </div>
            <SearchCard />
          </div>
        ...
        <section
          ref={featRef}
          style={{ ...fadeStyle(featVisible), padding: "84px 60px" }}
        >
          <div style={{ maxWidth: 1200, margin: "0 auto" }}>
            <div style={{ textAlign: "right", marginBottom: 40 }}>
              <p
        ...
        <div
          ref={ctaRef}
          style={{ ...fadeStyle(ctaVisible), padding: "72px 60px" }}
        >
          <div
            style={{
              background: "linear-gradient(135deg,#0b1324 0%,#131f36 100%)",
              borderRadius: 24,
              padding: "72px 48px",
              textAlign: "center",
              position: "relative",
          ...
          >
            <div
              style={{
                ...
                inset: 0,
                background:
                  "radial-gradient(ellipse at 25% 50%, rgba(59,130,246,0.08), transparent 55%), radial-gradient(ellipse at 75% 50%, rgba(99,102,241,0.07), transparent 55%)",
                pointerEvents: "none",
              }}
            />
            <h2
            ...
            >
              Transfer Vision into reality, blending the etheral beauty of the
              tangible strength of architecture
            </h2>
            <p
              style={{
                fontFamily: "'DM Sans', sans-serif",
            ...
            >
              Discover homes for sale or rent, explore locations on the map, and
              manage your property journey with ease. Discover homes for sale or
              rent, explore locations on the map, and manage your property
              journey with ease.
            </p>
            <button
              style={{
